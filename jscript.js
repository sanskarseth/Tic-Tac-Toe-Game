...
function printx(number){
    let thisone = document.getElementById("r"+number);
  console.log(thisone);
  
  if(thisone.innerText==""){
  thisone.innerText=sign;
  winner();
  checksign();
...
if(checkmove(1,2,3,sign)||checkmove(4,5,6,sign)||checkmove(7,8,9,sign)
    ...
    disp.innerHTML = "<center>" +sign + " Has Won The Game.." + "</center>";
    for(let i=1;i<=9;i++){
        document.getElementById("r"+i).innerHTML="";
    }
   throw "game end"; //to forcefully end the game
}else{
